...
function TodoContainer(props) {
    ...
    const alltasks = filteredTask.map((val,index)=> <Task  index= {index} key={index} filteredtask={filteredTask}  removetask= {removeTask} changeStatus={changeStatus} />)
    const completed = filteredTask.filter((val,i)=> val.status===true)
    const completedTasks = completed.map((val,index)=> <Task   index= {index} key={index} filteredtask={completed}  removetask= {removeTask} changeStatus={changeStatus} />)
    const uncompleted = filteredTask.filter((val,i)=> val.status===false)
    const uncompletedTasks = uncompleted.map((val,index)=> <Task  index= {index} key={index} filteredtask={uncompleted}  removetask= {removeTask} changeStatus={changeStatus} />)
